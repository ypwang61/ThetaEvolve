...
async def generate_rollout_async(
    ...
    Args:
        ...
        data_source: rollout data source object with `get_samples(...)`
    ...
    if getattr(args, "evolving_gym", False):
        ...
        assert hasattr(data_source, "evolving_gym_manager"), "data_source must have evolving_gym_manager attribute"
        gym = data_source.evolving_gym_manager.gym
...
def generate_rollout(
    ...
    Args:
        args: the whole args
        rollout_id: int, the id of the rollout, used for deterministic data generation
        data_source: the data source to fetch / store buffered samples
